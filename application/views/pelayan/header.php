			...
			<div class="container">
				...
				<div class="collapse navbar-collapse naff">
					<ul class="nav navbar-nav">
						<li class="active"><a href="<?php echo base_url('pelayan/home') ?>">Home</a></li>
						<?php foreach ($kategori as $key => $value): ?>
						<li><a href="<?php echo base_url("pelayan/menu/tampil/$value[id_kategori]") ?>"><?php echo $value['nama_kategori'] ?></a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="<?php echo base_url('pelayan/logout') ?>">Logout</a></li>
