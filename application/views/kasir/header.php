			...
			<div class="container">
				...
				<div class="collapse navbar-collapse naff">
					<ul class="nav navbar-nav">
						<li class="active"><a href="<?php echo base_url('kasir/home') ?>">Home</a></li>
						<?php foreach ($kategori as $key => $value): ?>
						<li><a href="<?php echo base_url("kasir/menu/tampil/$value[id_kategori]") ?>"><?php echo $value['nama_kategori'] ?></a></li>
							
						<?php endforeach ?>
						<li><a href="<?php echo base_url("kasir/pesanan") ?>">Pesanan</a></li>
						<li><a href="<?php echo base_url("kasir/pembayaran") ?>">Pembayaran</a></li>

					</ul>
					<ul class="nav navbar-nav navbar-right">

						<li><a href="<?php echo base_url('kasir/logout') ?>">Logout</a></li>
