...
class Pesanan extends CI_Controller {
	...
	{
		$id_user = $_SESSION['pelayan']['id_user'];
	...
	function ubah($id_pesanan)
	{
		...
		if($inputan)
		{
			...
			$inputan['id_user']= $_SESSION['pelayan']['id_user'];
			$this->M_pesanan->ubah_pesanan($id_pesanan, $inputan, $record);
			echo "<script>alert('pesanan berhasil disimpan')</script>";
			redirect("pelayan/pesanan", 'refresh');
		}
		$this->load->view('pelayan/header', $data);
		$this->load->view('pelayan/ubah_pesanan', $data);
	}
	...
	function tambah()
	{
		...
		$this->load->view('pelayan/header', $data);
		$this->load->view('pelayan/tambah_pesanan', $data);
	}
	...
	function tambah_menu($id_pesanan)
	{
		...
		$this->load->view('pelayan/header', $data);
		$this->load->view('pelayan/tambah_menu_pesanan', $data);
	...
	function pembayaran($id_pesanan)
	{
		...
		$this->load->view('pelayan/header', $data);
		$this->load->view('pelayan/pembayaran', $data);
	}
}
